...
public class ElectronConfiguration {
	...
	public static void main(String[]args) throws IOException {
		...
		Elements quizAnswerCheck = new Elements(quiz.getUserAnswer());
		
		//Write to file the users answer
		quiz.setWriteToFile();
		...
		if(quiz.getRandomAtomicNum() == quizAnswerCheck.getElementUserAnswer()){
			
			JOptionPane.showMessageDialog(null,  "You are correct! \n (Your quiz answer will be printed to the screen for your review.)", 
					"Element Quiz", JOptionPane.INFORMATION_MESSAGE);
			
			//print from file the users answer
			quiz.setReadFromFile();
			
		}else{
			
			JOptionPane.showMessageDialog(null,  "Sorry, you are incorrect. \n (Your quiz answer will be printed to the screen for your review.)", 
					"Element Quiz", JOptionPane.WARNING_MESSAGE);

			//Print from the file the users answers
			quiz.setReadFromFile();
		}
	}
}
